...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 25, 2023 at 01:52 AM
...
--
-- Table structure for table `all cars`
--

CREATE TABLE `all cars` (
  `IDV` int(11) NOT NULL,
...
--
-- Dumping data for table `all cars`
--

INSERT INTO `all cars` (`IDV`, `Nom et Prenom`, `Numero telephone`, `Marque`, `Nom`, `prix`, `Moteur`, `Carateristique`, `Description`, `img1`, `img2`, `img3`) VALUES
...
--
-- Table structure for table `rejected cars`
--

CREATE TABLE `rejected cars` (
  `IDV` int(11) NOT NULL,
  `Nom et Prenom` varchar(255) NOT NULL,
  `Numero telephone` int(11) NOT NULL,
  `Marque` varchar(30) NOT NULL,
...
--
-- Indexes for table `all cars`
--
ALTER TABLE `all cars`
  ADD PRIMARY KEY (`IDV`);
...
--
-- Indexes for table `rejected cars`
--
ALTER TABLE `rejected cars`
  ADD PRIMARY KEY (`IDV`);
